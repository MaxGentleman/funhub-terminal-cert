...
"manual:Moneris|MANUAL-REF":{
 ...
 fr:["Réveillez le terminal, puis **glissez le doigt sur l'écran de gauche à droite** et appuyez sur [[Quitter]] pour sortir de l'écran de veille.",
     "À [[Sign in]], effacez le champ [[Username]] - il garde la dernière personne - et tapez le vôtre. Laissez [[Remember me]] coché, puis appuyez sur [[Sign in]]. **Aucun mot de passe ici.**",
     "L'écran d'achat s'ouvre, intitulé [[Achat]] avec [[Entrez le montant de l'achat]].",
     "Appuyez sur le **menu trois points en haut à droite** - **pas** le menu hamburger en haut à gauche - et choisissez [[Remboursement]].",
     "Une demande de mot de passe apparaît : [[Veuillez entrer votre mot de passe pour accéder aux remboursements]]. Entrez-le et appuyez sur [[OK]]. **C'est la seule barrière.**",
...
"pos:Cluster|INT-REF":{
 en:["**Type YOUR manager PIN** before anything else.",
     ...
     "Pick a [[Reason of cancellation]] from the list. **Use the real reason.**",
 ...
 fr:["**Tapez VOTRE NIP de gestionnaire** avant toute chose.",
     ...
     "Ouvrez [[Search Receipt]], tapez le numéro dans [[Receipt #]] et appuyez sur le [[Continue]] vert.",
     ...
     "Dans la barre du bas, appuyez sur [[Delete Receipt]]. Le remboursement passe par **Delete Receipt**, **pas** par [[Edit payment]].",
     "Choisissez un [[Reason of cancellation]] dans la liste. **Utilisez la vraie raison.**",
     "Confirmez [[Would you like to delete this receipt?]] avec le **crochet vert**.",
     "Une deuxième invite demande [[Some payments were made on this order. Do you want to refund the customer?]] - tapez le [[Client Name]], puis appuyez sur [[Full Refund]], ou [[Partial Refund]] pour une partie.",
     "Cluster crée une commande de remboursement [[REMBOURSEMENT POUR]] avec la ligne négative. Appuyez sur [[CARD]] dans la colonne des modes de paiement.",
...
"pos:MYR|INT-REF":{
 en:["Go to the [[Orders]] page → switch to [[Completed]] and **select the order that needs to be refunded**.",
 ...
 fr:["Allez à la page [[Orders]] → passez à [[Completed]] et **sélectionnez la commande à rembourser**.",
     ...
     "[[ATTENTION! Are you sure that you want to refund this order?]] - appuyez sur [[Continue]].",
